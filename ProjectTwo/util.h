...
#define READ_STATUS_AMP     6

#define FULL_PATH_MAX 200
#define INPUT_BUFFER_SIZE 333
#define CURRDIR_BUFFER_SIZE 1024
...
typedef struct Process {
  ...
  unsigned int backgrounded; // True if there was an ampersand
} Process;
